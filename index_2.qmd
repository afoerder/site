...
<div class="split split-lead">
  ...
  <div class="prose">
    ...
    a stand-in for Mars; it was during my Ph.D., and at a NASA AI workshop in 2024,
    that I saw how these methods could be applied to planetary geoscience problems.
    So I rebuilt my dissertation around them. I taught myself deep learning by
    building the detection pipeline that work required, on a problem where the
    training data didn't exist and had to be made.</p>
