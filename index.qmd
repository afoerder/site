...
<div class="band">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <p class="card-line">The way cracks meet in frozen ground records what the
      climate did. Mars has over 100,000 orbital images and this had been surveyed by
      hand exactly once, so I built a pipeline that does it automatically.</p>
      <p class="card-metric">84% of junctions labeled correctly · a climate signal
      recovered at a scale hand-mapping cannot reach</p>
      <p class="card-links">
    ...
    <div class="card">
      ...
      <p class="card-metric">Earth can teach a model what to look for. Only Mars can
      tell it there is something there to find.</p>
      <p class="card-links">
        <a href="projects.html">Details</a>
