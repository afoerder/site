...
<div class="split split-lead">
  ...
  <div class="prose">
    ...
    result to report but a more useful one to have.</p>
    ...
    <p>If that sounds like someone you'd want to work with, get in touch.</p>
  </div>
  ...
  <div class="rail">
    ...
    <h4>Based in</h4>
    <p class="sub">Boulder, Colorado. PhD at the University of Tennessee, Knoxville.</p>
    ...
    <img class="rail-photo" src="images/alpine.jpg" alt="Rock-hopping a stream below a snow-dusted peak in the Colorado high country">
  </div>
...
<div class="band">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <h3 class="split-head">
        <span>Training on Earth</span><span class="sep" aria-hidden="true"><svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h16M14 6l6 6-6 6"/></svg></span><span>deploying on Mars</span>
      </h3>
    ...
    <div class="card">
      ...
      forecasts that cost nothing: what the season usually brings, and the conditions
      already prevailing. So I asked whether the record holds enough storms to prove
...
<div class="band band-pubs">
  ...
  <div class="pub">
    ...
    Toward planet-wide paleoclimate mapping on Mars by detecting and classifying fracture junctions with deep learning.</div>
  </div>
