...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-stage">
      ...
      <p class="stage-caption">One HiRISE tile through the full pipeline. Green marks
      correct classifications, orange marks errors against the hand-labeled reference.
      Stage 04 is zoomed relative to 01 through 03. HiRISE imagery: NASA/JPL/University
      of Arizona. REPLACE: add the location and the scale across the frame.</p>
    </div>
  </div>
...
<div class="band">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      same landforms on Mars? I trained segmentation models on three Earth landform
      classes, then tested them on Mars.</p>
      <p class="card-metric">The analogy carried real signal for some landforms and
      hit a resolution floor for others</p>
      <p class="card-links">
        <a href="projects.html">Details</a>
    ...
    <div class="card">
      ...
      <p class="card-line">Can a Martian dust storm be predicted? I asked whether the
      observational record contains enough information to prove that any proposed
      precursor beats a seasonal average. It does not, and I quantified by how much.</p>
